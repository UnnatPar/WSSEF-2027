...
def test_probe_and_finetune_configs_point_at_the_right_pretrain_checkpoint():
    ...
    mae_source = "pretrain_mae_v6"  # v1 abandoned Colab run; v2 collapsed-ReLU; v3 collapsed via weight decay on LayerNorm gains; v4 collapsed via missing LR warmup; v5 collapsed via peak LR too high even with warmup; v6 is the real one
